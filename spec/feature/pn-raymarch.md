# PN polynomial raymarch and live controls

## SPEC-PC-PN-RAYMARCH

The default Pictor PN demo exe renders the PN polynomial directly with bounded
...
a specific character, or to recover an unfinished character design.
