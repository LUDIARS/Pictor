# SPEC-PC-PN-STAGE — PN stage presentation
...
loaded once. A one-second normalized head-rotation reference is stretched to
18 seconds and drives only the small camera orbit. No game source dependency is
...
Operational recording uses a dedicated package in Pictor/build/pn-stage-demo
