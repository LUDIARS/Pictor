# <term-c01> PN interpolation demonstration, 2026-09-07
...
explicit limitations in `spec/feature/<term-c01>-raymarch.md`.
...
Pictor evaluates cubic PN patches derived from the local <term-c01> FBX's positions
...
The method and source equations are in `spec/feature/<term-c01>-reconstruction.md`;
launch instructions are in `spec/setup/<term-c01>-reconstruction.md`.
...
Excubitor (`pc-<term-c01>-capture`) after a Concordia testing claim. It generated all
...
Artifacts are local under `Pictor/build/<term-c01>-demo/`: executable, FBX, diffuse
...
are tracked in `spec/plan/<term-c01>-formula-roadmap.md`.
