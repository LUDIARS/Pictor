# <term-c01> formula model and subsequent cel-rendering demo
...
finish the <term-c01> formula-modeling plan first, then use it for a Pictor cel-look exe.
...
demo. See `spec/feature/<term-c01>-raymarch.md`. This changes the rendering milestone;
...
<term-c01> or supplies the missing design automatically.
...
tessellation and has an ocean tessellation demo, but the <term-c01> path is not wired.
...
requests; it is not a ready-made <term-c01> SDF surface renderer.
