...
if(!ffmpegInput||!directoryInput||!outputInput)
    throw new Error('Usage: encode_<term-c01>_stage.mjs <ffmpeg.exe> <frame-directory> <output.mp4>');
...
const labels="drawtext=fontfile='C\\:/Windows/Fonts/arial.ttf':text='<term-c01>':x=28:y=28:fontsize=24:fontcolor=white,drawtext=fontfile='C\\:/Windows/Fonts/arial.ttf':text='STAGE C  /  PN RAYMARCH':x=28:y=60:fontsize=13:fontcolor=0x9999aa,fade=t=in:st=0:d=0.3,fade=t=out:st=17.5:d=0.5";
