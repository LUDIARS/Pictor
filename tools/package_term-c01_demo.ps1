...
Copy-Item -LiteralPath $Binary -Destination (Join-Path $target 'pictor_<term-c01>_demo.exe')
...
Copy-Item -LiteralPath (Join-Path $repoRoot 'spec/setup/<term-c01>-reconstruction.md') -Destination (Join-Path $target 'README.md')
Copy-Item -LiteralPath (Join-Path $repoRoot 'spec/feature/<term-c01>-reconstruction.md') -Destination (Join-Path $target 'RESEARCH.md')
Copy-Item -LiteralPath (Join-Path $repoRoot 'spec/feature/<term-c01>-raymarch.md') -Destination (Join-Path $target 'RAYMARCH.md')
Copy-Item -LiteralPath (Join-Path $repoRoot 'spec/tasks/20260907-<term-c01>-pn-demo.md') -Destination (Join-Path $target 'VALIDATION.md')
Copy-Item -LiteralPath (Join-Path $repoRoot 'spec/plan/<term-c01>-formula-roadmap.md') -Destination (Join-Path $target 'ROADMAP.md')
